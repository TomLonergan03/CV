...
%  \href{https://jane-doe.com}{\uline{jane-doe.com}} $|$ % row = 2, col = 1
  \href{https://www.linkedin.com/in/tomlonergan03/}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/TomLonergan03}{\uline{GitHub}} %$|$ % row = 2, col = 1
%  \href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
&
  Email: \href{mailto:tomlonergan91@gmail.com}{\uline{tomlonergan91@gmail.com}} $|$ % row = 2, col = 2
